...
> 提示：战役开始时，您就已经着陆在[乌尔][Ur]了——单击离开船舱手柄即可进入城市，为接下来的旅程购买燃料和特殊弹药。
...
1. **舰队** - 您当前所在位置。黄圈是您的*对敌跟踪距离*——来自目视和可能配备的雷达（注意雷达的探测距离可以比此更远，参见[*雷达系统*](#雷达系统)章节）。
2. **燃料续航** - 蓝圈是您当前燃料可以航行的距离。
3. **地点** - 贸易路线上的城市或哨站。其名称后的图标标示着你可以在此获取的东西，鼠标悬停可以查看更多信息。
